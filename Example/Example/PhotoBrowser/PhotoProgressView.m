...
#define DegreeToRadian(x) (M_PI/180.0 * (x))
...
{    
    ...
    CGFloat radians = DegreeToRadian((_progress*359.9)-90);
    ...
    CGPathAddArc(trackPath, NULL, centerPoint.x, centerPoint.y, radius, DegreeToRadian(270), DegreeToRadian(-90), NO);
    ...
    CGPathAddArc(progressPath, NULL, centerPoint.x, centerPoint.y, radius, DegreeToRadian(270), radians, NO);
